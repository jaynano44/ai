...
SELECT * FROM SALGRADE;
SELECT * FROM DEPT;
SELECT ENAME,SAL,GRADE,E.DEPTNO,DNAME,LOC,COMM
...
SELECT WORKER.EMPNO,WORKER.ENAME,WORKER.MGR,MANAGER.EMPNO,MANAGER.ENAME 매니저
    ...
    SELECT W.EMPNO,W.ENAME,W.MGR,M.EMPNO,M.ENAME
        FROM EMP W, EMP M
        WHERE W.MGR=M.EMPNO;  --W.MGR=NULL인 KING 제외 => OUTER JOIN에서
